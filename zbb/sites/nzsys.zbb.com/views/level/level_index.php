...
<link href="<?php echo $this->config->item('domain_static'); ?>system/css/common.css" rel="stylesheet" type="text/css" />
    ...
    <body>
        ...
        <div class="g-mnr">
            <div class="tools">
            <ul class="toolbar">
                <li><a href="/level/add">新增管理员权限<span><img src="<?php echo $this->config->item('domain_static'); ?>system/images/t01.png" /></span></a></li>
            </ul>
            </div>
                ...
                <tbody>
                    <?php foreach ($list as $item): ?>
                        <tr align="center">
                            ...
                            <td width="515px"><?php echo $item['level_id'] ?></td>
                            <td><?php echo $item['super_admin'] ?></td>
                            <td><a href="/level/edit/id/<?php echo $item['id'] ?>">修改权限</a></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>

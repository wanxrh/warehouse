...
<li><label>分类名称<b>*</b></label>
  ...
  <input  name="cate_name" maxLength="15" type="text" class="dfinput" value="" />
  <i>名称不能超过15个字符</i>
</li>

<li><label>上级分类<b>*</b></label>
	<select id="cate_id" class="dfinput" style="width:110px;"  name="parent_id">
...
<input maxLength="3" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" name="sort_order" type="text" class="dfinput" value="255"  style="width:300px;"/>
</li>   

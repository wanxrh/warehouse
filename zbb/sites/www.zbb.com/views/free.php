...
<body>
    ...
    <div class="g-mod g-wrap j_ImgLoad">
        <div class="m-tt">
            <ul class="clearfix">
                <li<?php if($cid==3){?> class="z-crt"<?php }?>><a href="/baoyou-3.html">9.9包邮</a><span></span></li>                
                <li<?php if($cid==4){?> class="z-crt"<?php }?>><a href="/baoyou-4.html">29.9包邮</a><span></span></li>
                <li<?php if($cid==5){?> class="z-crt"<?php }?>><a href="/baoyou-5.html">49.9包邮</a><span></span></li>
            </ul>
        </div>
        <div class="m-ct" id="J_tab_ct">
            <!-- 9.9包邮 -->
            <ul class="g-list">
                <?php if($goods_list) {?>

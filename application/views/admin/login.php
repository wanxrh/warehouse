...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo $this->config->base_url(); ?>static/css/admin/login.css" media="all">
       	<link rel="stylesheet" type="text/css" href="<?php echo $this->config->base_url(); ?>static/css/admin/default_color.css" media="all">
    </head>
    <body id="login-page">
        <div id="main-content">
            ...
            <div class="login-body">
                <div class="login-main pr">
                    <form action="/login" method="post" class="login-form">
                        <h3 class="welcome"><i class="login-logo"></i>老山圈管理平台</h3>
                        <div id="itemBox" class="item-box">
                            ...
                            <div class="item verifycode">
                                ...
                                <input type="text" name="vcode" placeholder="请填写验证码" autocomplete="off">
                                <a class="reloadverify" title="换一张" href="javascript:void(0)">换一张？</a>
                            </div>
                            <span class="placeholder_copy placeholder_check">请填写验证码</span>
                            <div>
                                <img class="verifyimg reloadverify" alt="点击切换" src="/login/vcode">
                            </div>
	...
	<!--[if lt IE 9]>
    <script type="text/javascript" src="<?php echo $this->config->base_url(); ?>static/js/jquery-1.10.2.min.js"></script>
    <![endif]-->
    <!--[if gte IE 9]><!-->

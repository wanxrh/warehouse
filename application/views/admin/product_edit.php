					...
					<div class="form-item cf toggle-category_id">
						...
						<div class="controls">
							<select name="type">
								...
								<option value="产品介绍" <?php if($info['type']=='产品介绍'):?>selected="selected"<?php endif;?>>产品介绍</option>
								<option value="生长过程"<?php if($info['type']=='生长过程'):?>selected="selected"<?php endif;?>>生长过程</option>
								<option value="农人感言" <?php if($info['type']=='农人感言'):?>selected="selected"<?php endif;?>>农人感言</option>
								<option value="检测报告" <?php if($info['type']=='检测报告'):?>selected="selected"<?php endif;?>>检测报告</option>
								<option value="图文混编推荐吃法" <?php if($info['type']=='图文混编推荐吃法'):?>selected="selected"<?php endif;?>>图文混编推荐吃法</option>

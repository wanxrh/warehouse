				...
				<div class="tab-content">
					...
					<form id="form" action="/admin/editproduct" method="post" class="form-horizontal form-center">
						...
						<div class="form-item cf toggle-title">
							...
							<div class="controls">
								<label class="textarea">
									<textarea name="product_cource" class="" style="width: 405px; height: 70px;"><?php echo $info['product_cource'];?></textarea>
								</label>
							</div>
						</div>
						<div class="form-item cf toggle-title">
							...
							<div class="controls">
								<label class="textarea">
									<textarea name="product_trait" class="" style="width: 405px; height: 70px;"><?php echo $info['product_trait'];?></textarea>
								</label>
							</div>
						</div>
						<div class="form-item cf toggle-title">
							...
							<div class="controls">
								<label class="textarea">
									<textarea name="farm" class="" style="width: 405px; height: 70px;"><?php echo $info['farm'];?></textarea>
								</label>
							</div>
						</div>
						<div class="form-item cf toggle-title">
							...
							<div class="controls">
								<label class="textarea">
									<textarea name="record" class="" style="width: 405px; height: 70px;"><?php echo $info['record'];?></textarea>
								</label>
							</div>
						</div>
						<div class="form-item cf toggle-title">
							...
							<div class="controls">
								<label class="textarea">
									<textarea name="node" class="" style="width: 405px; height: 70px;"><?php echo $info['node'];?></textarea>
								</label>
							</div>
						</div>
						<div class="form-item cf toggle-title">
							...
							<div class="controls">
								<label class="textarea">
									<textarea name="importance" class="" style="width: 405px; height: 70px;"><?php echo $info['importance'];?></textarea>
								</label>
							</div>
						</div>
						<div class="form-item cf toggle-title">
							...
							<div class="input-span fileupload">
                                <span class="uneditable-span">
                                    <?php echo $info['farmer_movie'];?>
                                </span>
								<span class="default btn-file">

                                    <span class="fileupload-new" <?php if(isset($info['farmer_movie'])&& !empty($info['farmer_movie'])):?>style="display:none;"<?php endif;?>>
                                        &nbsp;&nbsp;&nbsp;浏览
                                    </span>
                                    <span class="fileupload-exists" <?php if(isset($info['farmer_movie'])&& !empty($info['farmer_movie'])):?>style="display:block;"<?php endif;?>>
                                        &nbsp;&nbsp;&nbsp;更换
                                    </span>
                                    <input type="file" class="default" id="p_farmer_movie" name="p_farmer_movie" onchange="return ajaxFileUpload(this)" />
                                </span>
								<input type="hidden" value="<?php echo $info['farmer_movie'];?>" name="farmer_movie" class="hidden_value form-control" />
								<a href="javascript:;" class="btn red fileupload-exists" data-dismiss="fileupload" <?php if(isset($info['farmer_movie'])&& !empty($info['farmer_movie'])):?>style="display:inline;"<?php endif;?>>
						...
						<div class="form-item cf toggle-imgs">
							...
							<div id="uploader">
								<div class="queueList">
									...
									<div id="filePicker" ></div>
									<ul class="filelist">
										<?php foreach (explode(',', $info['farmer_picture']) as $v) { ?>
							...
							<input id="uploadimg" type="hidden" value="<?php echo $info['farmer_picture']; ?>" name="farmer_picture">
						</div>
						<div class="form-item cf toggle-title">
							<label class="item-label">
								<span class="need_flag">*</span>
							...
							<div class="controls">
								<label class="textarea">
									<textarea name="farmer_info" class="" style="width: 405px; height: 70px;"><?php echo $info['farmer_info'];?></textarea>
								</label>
							</div>
						</div>
						<div class="form-item cf toggle-title">
							...
							<div class="input-span fileupload">
                                <span class="uneditable-span">
                                    <?php echo $info['report'];?>
                                </span>
								<span class="default btn-file">
                                    <span class="fileupload-new"<?php if(isset($info['report'])&& !empty($info['report'])):?>style="display:none;"<?php endif;?>>
                                        &nbsp;&nbsp;&nbsp;浏览
                                    </span>
                                    <span class="fileupload-exists"<?php if(isset($info['report'])&& !empty($info['report'])):?>style="display:block;"<?php endif;?>>
                                        &nbsp;&nbsp;&nbsp;更换
                                    </span>
								...
								<a href="javascript:;" class="btn red fileupload-exists" data-dismiss="fileupload" <?php if(isset($info['report'])&& !empty($info['report'])):?>style="display:inline;"<?php endif;?>>
									<i class="icon icon-trash"></i> 删除
								</a>
							</div>
						</div>
						<div class="form-item cf toggle-title">
							...
							<div class="controls">
								<label class="textarea">
									<textarea name="cook" class="description" style="width: 405px; height: 100px;"><?php echo $info['cook'];?></textarea>
								</label>
							</div>
						</div>
						<script>

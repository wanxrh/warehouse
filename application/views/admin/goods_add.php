			...
			<div class="tab-content">
				...
				<form id="form" action="/admin/addgoods" method="post" class="form-horizontal form-center">
					...
					<div class="form-item cf toggle-category_id">
						...
						<div class="controls">
							<select name="category_id">
								...
								<option value="<?php echo $v['id']; ?>" class="toggle-data" toggle-data=""><?php echo $v['title']; ?></option>
								<?php }; ?>
							</select>
						</div>
					</div>
					...
					<div class="form-item cf toggle-price">
						...
						<div class="controls">
							<input type="number" oninput="if(value.length>2)value=value.slice(0,2)" class="text" name="commission" value="0"> * 0.01
						</div>
					</div>

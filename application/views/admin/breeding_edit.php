			...
			<div class="tab-content">
				...
				<input type="hidden" name="id" value="<?php echo $info['id'];?>">
					...
					<div class="form-item cf toggle-title">
						...
						<div class="controls">
							<input type="text" class="sang_Calender" name="outtime" value="<?php echo date("Y-m-d",$info['outtime']);?>"/>
						</div>
					</div>
					<div class="form-item cf toggle-imgs">
						...
						<div id="uploader">
							<div class="queueList">
								...
								<div id="filePicker" ></div>
								<ul class="filelist">
										<?php foreach (explode(',', $info['picture']) as $v) { ?>
						...
						<input id="uploadimg" type="hidden" value="<?php echo $info['picture'];?>" name="picture">
					</div>
					<div class="form-item cf toggle-title">
						<label class="item-label">
							视频
						...
						<div class="input-span fileupload">
							...
							<span class="default btn-file">
                                    <span class="fileupload-new" <?php if(isset($info['video'])&& !empty($info['video'])):?>style="display:none;"<?php endif;?>>
                                        &nbsp;&nbsp;&nbsp;浏览
                                    </span>
                                    <span class="fileupload-exists" <?php if(isset($info['video'])&& !empty($info['video'])):?>style="display:block;"<?php endif;?>>
                                        &nbsp;&nbsp;&nbsp;更换
                                    </span>
                                    <input type="file" class="default" id="p_farmer_movie" name="p_farmer_movie" value="<?php echo $info['video'];?>" onchange="return ajaxFileUpload(this)" />
                                </span>
							<input type="hidden" value="<?php echo $info['video'];?>" name="video" class="hidden_value form-control" />
							<a href="javascript:;" class="btn red fileupload-exists" data-dismiss="fileupload" <?php if(isset($info['video'])&& !empty($info['video'])):?>style="display:inline;"<?php endif;?>>
					...
					<div class="form-item cf toggle-title">
						...
						<div class="controls">
							<label class="textarea">
								<textarea name="instructions" class="" style="width: 405px; height: 70px;"><?php echo $info['instructions'];?></textarea>
							</label>
						</div>
					</div>

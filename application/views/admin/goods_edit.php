        ...
        'link', 'unlink' ]
				...
				<div class="form-item cf toggle-sort">
						...
						<div class="controls">
							<div class="check-item">
								...
								<input type="radio" class="regular-radio toggle-data" value="0"
									   id="reserve_0" name="reserve" toggle-data="" <?php if($info['reserve'] ==0){ echo 'checked'; } ?>/>
								...
								<?php if($info['reserve'] ==0){ echo 'checked="true"'; } ?>/>
								<label for="reserve_0"></label>否                               <![endif]-->
							</div>
							<div class="check-item">
								<!--[if !IE]><!-->
								<input type="radio" class="regular-radio toggle-data" value="1"
									   id="reserve_1" name="reserve" toggle-data="" <?php if($info['reserve'] ==1){ echo 'checked'; } ?>/>
								<label for="reserve_1"></label>
								是
								<!--<![endif]-->
								<!--[if IE]>
								<input type="radio" value="1"
									   id="is_show_1" name="reserve" class="toggle-data" toggle-data=""
								<?php if($info['reserve'] ==1){ echo 'checked="true"'; } ?>
								/>
					...
					<div class="form-item cf toggle-sort">
						...
						<div class="controls">
							<input type="text" class="text" name="reserve_time" value="<?php echo $info['reserve_time']?date('Y-m-d',$info['reserve_time']):'' ;?>">
						</div>
					</div>

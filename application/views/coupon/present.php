        ...
        <div class="order_action">
            <?php if($coupon['status'] == 0){ ?>
                <?php if($super){ ?>
                    ...
                    <a href="javascript:;" onclick="$('#form').submit();" class="btn">确认礼品券</a>
                <?php }else{ ?>
                    <h3 class="mb_10" style="color: red;">该纸质礼品券点击“确认”后，立即变成电子礼品券</h3>
                    <h3 class="mb_10" style="color: red;">（注意：变成电子券之后，纸质礼品券就会失效）</h3>
                    关注老山圈公众号，就可使用电子券~
                    <div class="m_15">
